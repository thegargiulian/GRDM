...
#load death data
deaths <- read_dta("data/spread/1939_Austria/01_tote_ww2.dta")

#load denominator data
pops <- read_dta("data/spread/1939_Austria/gem_hist_einwohner.dta")

#load municipality merger mapping
map <- read_dta("data/spread/1939_Austria/01_gem_timeline_1939-2011.dta")
