...
pop_2000 <- read.table("data/spread/2020_US/nhgis0012_ds146_2000_county.csv",
                       header = TRUE, sep = ',', skip = 1)
pop_2010 <- read.table("data/spread/2020_US/nhgis0012_ds172_2010_county.csv",
                       header = TRUE, sep = ',', skip = 1)
pop_2022 <- read.csv("data/spread/2020_US/co-est2022-alldata.csv")

#load death data
deaths <- read_feather("data/spread/2020_US/COVIDUCDMonthlyData.feather")
