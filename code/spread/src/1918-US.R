...
# Maintainers: MG, HG
# =========================================
# GRDM/code/spread/src/1918-US.R
...
pops <- read.csv(here::here("data/spread/1918_US/us_denominators.csv"))

#load death data
deaths <- read.csv(here::here("data/spread/1918_US/us_excess.csv"))
