...
pops <- read.csv("data/spread/1980_ElSalvador/elsalvador_denominators.csv")

#load death data
deaths <- read.csv("data/spread/1980_ElSalvador/elsalvador_MSE.csv")
