...
pacman::p_load(dplyr, ggplot2, readxl, tidyr)

#load denominator file
pops_file <- "data/spread/1871_Amsterdam/population_by_neighborhood.xlsx"
...
#load death data
deaths <- read_xlsx("data/spread/1871_Amsterdam/Smallpox_1871_Amsterdam_neighborhood.xlsx")
