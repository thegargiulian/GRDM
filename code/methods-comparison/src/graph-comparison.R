...
args <- list(plot_absolute = "code/gold-standard-comparison/output/Comparison-Absolute.png",
             plot_relative = "code/gold-standard-comparison/output/Comparison-Relative.png")

# ----- data

comparison_data <- read.csv("data/gold-standard-comparison/comparisons.csv")
denominator_data <- read.csv("data/gold-standard-comparison/denominators.csv")
